...
FlatCallable = Callable[..., Sequence[RV]] # don't know how to enforce that inputs are RV
...
def vmap_subgraph(dummy_roots: Sequence[RV], dummy_nodes: Sequence[RV], dummy_outputs: Sequence[RV], roots: Sequence[RV], roots_axes: Sequence[int | None], axis_size: int | None) -> list[RV]:
    """
...
def vmap_eval_flat(f: FlatCallable, in_axes: Sequence[int | None], axis_size: int | None, *args: RV_or_ArrayLike):
    """
